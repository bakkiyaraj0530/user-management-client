...
class UserModal extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        if (props.usermodal !== state.usermodal) {
            return {
                usermodal: props.usermodal,
                fullname: props.usermodal && props.usermodal.fullname,
                email: props.usermodal && props.usermodal.email,
                group: props.usermodal && props.usermodal.group._id,
                type: props.usermodal && props.usermodal.type
            }
